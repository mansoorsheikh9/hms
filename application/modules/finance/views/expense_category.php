                            ...
                            <tr class="">
                                ...
                                <?php if ($this->ion_auth->in_group(array('admin', 'Accountant'))) { ?>
                                    <td>
                                        ...
                                        <a class="btn btn-info btn-xs btn_width delete_button" href="finance/deleteExpenseCategry?id=<?php echo $category->id; ?>" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php } ?>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Expense Category</h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editCategoryForm" action="finance/addExpenseCategory" method="post" enctype="multipart/form-data">
